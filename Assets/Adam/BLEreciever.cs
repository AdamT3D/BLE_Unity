...
public class BLEreciever : MonoBehaviour
{
	enum States
	{
		None,
	...
	//hardcoded device Universally Unique Identifier
	[SerializeField]
	...
	{
		//ui initialization
		HM10_Status = uiManager.HM10_Status;
		BluetoothStatus = uiManager.BluetoothStatus;
		PanelMiddle = uiManager.PanelMiddle;
		TextToSend = uiManager.TextToSend;
